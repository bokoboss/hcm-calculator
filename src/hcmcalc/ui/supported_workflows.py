...
SUPPORTED_WORKFLOW_SECTIONS: tuple[WorkflowSection, ...] = (
    ...
    },
    {
        ...
        "supported": [
            ...
            "Measured FFS or estimated FFS with active roadway geometry inputs",
            "Two- or three-lane estimated FFS, including divided-median left-side clearance",
        ...
        "limitations": [
            ...
            "internal PCE lookup is limited to printed table mixtures and numeric boundaries; use an external PCE otherwise",
            "estimated FFS is unavailable for lane counts other than two or three per direction",
            "above-capacity cases report LOS F and capacity failure without predicted speed or density",
